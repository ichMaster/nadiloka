...
- [ ] NADI-005 — Grid and neighbourhood helpers (S; after NADI-002)
- [ ] NADI-006 — Tejas scalar field + `Patch` model (M; after NADI-005)
- [ ] NADI-007 — Patch lifecycle in the update-Tejas phase (M; after NADI-006, NADI-003)
